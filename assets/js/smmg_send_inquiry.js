(function ($, Drupal, drupalSettings) {
  ...
  function removeFromList(list) {
    ...
    $trigger.click(function (e) {
      ...
      // get Data
      var subscriber_group_id = this.dataset.subscriberGroupId;
      var subscriber_group_name = drupalSettings.subscribers[subscriber_group_id].title;

      var subscriber_id = this.dataset.subscriberId;
      var subscriber_name = drupalSettings.subscribers[subscriber_group_id]['members'][subscriber_id];
